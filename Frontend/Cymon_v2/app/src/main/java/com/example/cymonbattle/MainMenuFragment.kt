...
import com.example.battleparty.MainScreen
...
class MainMenuFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.trainerBattleButton.setOnClickListener {
            ...
            goToBattleActivity(false,false)
        }

        binding.wildPokemonButton.setOnClickListener {
            this.spinner.visibility = View.VISIBLE
            goToBattleActivity(true,false)
        }

        binding.btnMultiplayer.setOnClickListener {
            this.spinner.visibility = View.VISIBLE
            goToBattleActivity(true,true)
        }
     ...
     */
    private fun goToBattleActivity(isWildPokemon: Boolean,isMultiPlayer:Boolean) {
        ...
        intent.putExtra("IS_MULTI",isMultiPlayer);
