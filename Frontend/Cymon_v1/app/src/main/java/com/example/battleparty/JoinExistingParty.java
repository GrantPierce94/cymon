...
public class JoinExistingParty extends AppCompatActivity implements WebSocketListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                if (!buttonText.isEmpty()) {
                    ...
                    if (roomLeft >0) {
                        ...
                        WebSocketManager.getInstance().sendMessage("joinParty " + currentPlayerName + " " + partyName, UtilEnum.CONTROLLER.PARTYCONTROLLER);
                    }
                }
            }
        });
        ...
        getPartyBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                WebSocketManager.getInstance().sendMessage("getParties", UtilEnum.CONTROLLER.PARTYCONTROLLER);
            }
        });
