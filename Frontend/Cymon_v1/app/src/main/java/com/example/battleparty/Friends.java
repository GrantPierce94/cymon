...
public class Friends extends AppCompatActivity implements WebSocketListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String serverUrl = UtilEnum.URL.BASE_URL + "player/" + currentPlayerName + "/";
        ...
        addPlayer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                WebSocketManager.getInstance().sendMessage("add " + playerToSearch, UtilEnum.CONTROLLER.FRIENDCONTROLLER);
            }
        });
        ...
        getFriends.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                WebSocketManager.getInstance().sendMessage("getFriends", UtilEnum.CONTROLLER.FRIENDCONTROLLER);
            }
        });
