...
class BattleActivitySharedViewModel(
    ...
    fun setActivePlayerPokemon(pokemon: Pokemon){
        ...
        nubber.sendMessage("Player ${activePlayerPokemon.value!!.SPECIES} is sent out");
    }
    ...
    private fun actionActivePlayerPokemonDied(): BattleState{
        ...
        nubber.sendMessage("Player ${activePlayerPokemon.value!!.SPECIES} fainted");
    ...
    private fun actionActiveOpponentPokemonDied(): BattleState{
        ...
        nubber.sendMessage("Opponent ${_activeOpponentPokemon.value!!.SPECIES} fainted");
        ...
        nubber.sendMessage("Opponent ${_activeOpponentPokemon.value!!.SPECIES} is sent out");
    ...
    private fun xpUpActivePlayerPokemon(){
        ...
        nubber.sendMessage("Player ${activePlayerPokemon.value!!.SPECIES} gained $xpGained xp");
        if(activePlayerPokemon.value!!.canPokemonLevelUp()) {
            ...
            nubber.sendMessage("Player ${activePlayerPokemon.value!!.SPECIES} leveled up!");
        }
        _activePlayerPokemon.value = activePlayerPokemon.value
    }
